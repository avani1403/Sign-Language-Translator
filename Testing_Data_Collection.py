...
#to generate images we use this file
#keep press on one charcater and it captures images until you wont remove your finger from it
...
while True:
    ...
    # we dont require black n window so we r commenting it
